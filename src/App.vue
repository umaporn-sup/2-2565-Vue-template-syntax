...
<template>
  <div class="w-full">
    <div class="w-full flex-col">
      ...
      <div class="w-full mt-5 p-5">
        <table class="w-full">
          <thead class="bg-gray-50 border-b-2 border-gray-200">
            <tr>
              <th class="text-left font-semibold tracking-wide p-3">Section</th>
              <th class="text-left font-semibold tracking-wide p-3">
                Project Name
              </th>
              <th class="text-left font-semibold tracking-wide p-3">
                GitHub Repository
          ...
          <tbody>
            <tr
              ...
              v-for="(groupwork, index) in groupworks"
              :key="index"
            >
              <td>{{ groupwork.section }}</td>
              <td>
                <span class="bg-green-200 bg-opacity-20">
                  {{ groupwork.projectName }}</span
                >
              </td>
              <td>
                <a
      ...
      <!-- column#3 (footer) -->
      <div class="w-full flex justify-center">{{ getFooter('short') }}</div>
    </div>
  </div>
</template>
<style scoped></style>
